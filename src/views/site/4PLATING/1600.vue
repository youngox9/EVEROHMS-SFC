  ...
  <Layout :auth="true">
    ...
    >
      ...
      <el-row :gutter="24">
        ...
        <el-col :xs="24" :sm="8">
          <!-- 良品重量 -->
          <el-form-item :label="$t('SFFBUD019')" prop="SFFBUD019">
            <el-input
              type="number"
              v-model="form.SFFBUD019"
              :placeholder="'SFFBUD019'"
            ></el-input>
          </el-form-item>
        </el-col>
      </el-row>
...
async function postSave() {
  ...
  try {
    ...
    const res1 = await axios({
      url: "/4plating/sfc/1600/csft335_sffb_save01",
      method: "post",
      data: {
        ENT: ENT.value,
...
async function onSearch() {
  ...
  try {
    const res = await axios({
      url: `/4plating/sfc/1600/csft335_sffb_get01`,
      method: "post",
      data: {
        ENT: ENT.value,
