  ...
  <Layout :auth="true">
    ...
    >
      ...
      <el-row :gutter="24">
        ...
        <el-col :xs="24" :sm="8">
          ...
          <el-form-item :label="$t('SFFB007')">
            ...
            ></el-input>
            <p class="form-item-info">測試、包裝</p>
          </el-form-item>
        </el-col>
        <el-col :xs="24" :sm="8">
          <!-- 報工料號 -->
          <el-form-item :label="$t('SFFB029')">
            ...
            <div class="form-item-info">
              <!-- <p>sffb_xxxdesc</p> -->
              <p>{{ form.SFB029_DESC1 }}</p>
              <p>{{ form.SFB029_DESC2 }}</p>
            </div>
          </el-form-item>
        </el-col>
      </el-row>
      ...
      <el-row :gutter="24">
        ...
        <!--  -->
        <el-col :xs="24" :sm="8">
          <el-form-item :label="$t('SFFB017_1')" prop="SFFB017_1">
            <el-input
      ...
      <el-row :gutter="24">
        <el-col :xs="24" :sm="8">
          <el-form-item :label="$t('SFFBUS001')" prop="SFFBUS001">
            <el-input
              type="text"
              v-model="form.SFFBUS001"
              :controls="false"
            ></el-input>
          </el-form-item>
        </el-col>
        <el-col :xs="24" :sm="8">
          <el-form-item :label="$t('SFFBUS002')" prop="SFFBUS002">
            <el-input type="text" v-model="form.SFFBUS002" :controls="false" />
          </el-form-item>
        </el-col>
        <el-col :xs="24" :sm="8">
